...
The Klipper Configuration file by Majarspeed for Fysetc Spider V1.1 board is [located here](https://github.com/majarspeed/Voron-Trident/blob/main/Firmware/voron-trident-spider.cfg){:target="_blank" rel="noopener"};
